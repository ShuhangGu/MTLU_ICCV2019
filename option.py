...
parser.add_argument('--extend', type=str, default='.',
                    help='pre-trained model directory')
parser.add_argument('--g_blocks', type=int, default=4,
                    help='number of residual blocks')
parser.add_argument('--m_blocks', type=int, default=4,
                    help='number of residual blocks')

parser.add_argument('--shuffle_scale', type=int, default=4,
                    help='shuffle_scale')
...
parser.add_argument('--bin_width', type=float, default=0.05,
                    help='number of feature maps')
parser.add_argument('--fuse_operation', type=str, default='Concate',
                    help='fusion operation')
